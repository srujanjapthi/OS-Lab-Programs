/**
 * Implement Priority Pre-emptive scheduling algorithm by defining process structure.
 */
...
void prioritySchedulingPreemptive(int n, Process processes[]) {
...
void main() {
    ...
    prioritySchedulingPreemptive(n, processes);
